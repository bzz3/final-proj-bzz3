...
HD_PWD='D:/git/final-proj-bzz3/bzz3finalproj/bzz3finalproj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bzz3top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bzz3top.tcl -notrace
