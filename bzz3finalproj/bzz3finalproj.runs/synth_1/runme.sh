...
HD_PWD='D:/git/final-proj-bzz3/bzz3finalproj/bzz3finalproj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bzz3top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bzz3top.tcl
